...
- [Windows 免安装客户端](https://github.com/Liccha/Bot-Workstation/releases/download/demo-v1.1.13-1/BotWorkstation-Demo-Windows.zip)：解压后运行 `BotWorkstationDemo.exe`。
- [Android App](https://github.com/Liccha/Bot-Workstation/releases/download/demo-v1.1.13-1/BotWorkstation-Demo-Android.apk)：使用独立应用 ID，可与正式版并存；首次启动自动领取临时体验令牌。
